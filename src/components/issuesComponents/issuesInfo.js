...
"“Our idols, just like ourselves, are imperfect.”",
  ...
  {
    picture: require("../../static/issues/dream-theory.jpg"),
    title: "Dream Theory",
  ...
  {
    picture: require("../../static/issues/(re)connecting.jpg"),
    title: "(re)connecting",
  ...
  {
    picture: require("../../static/issues/duality.jpg"),
    title: "Duality",
  ...
  {
    picture: require("../../static/issues/the-shift.jpg"),
    title: "The Shift",
  ...
  {
    picture: require("../../static/issues/sincerely-yours.jpg"),
